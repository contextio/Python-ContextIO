...
class App(Api):
    ...
    def get_webhook_logs(self, **params):
        ...
        return [o for obj in self._request_uri("logs/webhooks", params=params)]
    ...
    def get_call_logs(self, **params):
        ...
        params = sanitize_params(params, all_args)
        return [o for obj in self._request_uri("logs/calls", params=params)]
    ...
    def get_status_callback_url(self):
        ...
        Arguments: none
        """
        return [o for obj in self._request_uri("status_callback_url", params=params)]
